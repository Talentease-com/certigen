...
export default function WorkshopsPage() {
	...
	const [form, setForm] = useState({ code: "", title: "", date: "", templateId: "" });
	...
	const openEdit = (w: Workshop) => {
		...
		setEditForm({ title: w.title, date: w.date, templateId: w.templateId || "" });
	};
	...
	const handleEdit = async (e: React.FormEvent) => {
		...
		setSubmitting(true);
		try {
			await updateWorkshop(editingWorkshop.id, editForm);
